          ...
          <motion.div variants={itemVariants} className="space-y-8">
            ...
            <div className="flex items-start gap-5 max-w-lg">
              ...
              <p className="text-xl text-slate-400 font-medium leading-relaxed">
                Recovery index is{" "}
                <span className="text-white font-black italic underline decoration-sky-500 decoration-4 underline-offset-8">
                  94% (PEAK)
                </span>
            ...
            <div className="flex flex-wrap gap-6 pt-4">
              <button className="group flex items-center gap-6 rounded-[2rem] bg-sky-500 px-12 py-7 text-sm font-black text-slate-950 shadow-2xl shadow-sky-500/30 transition-all hover:bg-sky-400 active:scale-95 uppercase tracking-[0.2em]">
                <Link to={"/dashboard/workouts"}>Initialize Workout</Link>{" "}
                <Play
                  size={20}
                  fill="currentColor"
              ...
              <div className="relative inline-flex items-center justify-center mb-10">
                ...
                <div className="absolute flex flex-col items-center">
                  <span className="text-6xl font-black italic tracking-tighter tabular-nums text-white">
                    75<span className="text-2xl text-slate-500">%</span>
                  </span>
        ...
        >
          <div className="relative overflow-hidden rounded-[3rem] w-full xl:w-110 h-80 shrink-0 shadow-2xl">
            ...
            <div className="absolute top-8 left-8 bg-sky-500 px-6 py-2.5 rounded-2xl shadow-2xl">
              <span className="text-[10px] font-black text-slate-950 uppercase tracking-[0.3em] italic">
                Tier 1 Session
              </span>
            </div>
          </div>
          ...
          <div className="flex-1 space-y-8 text-center xl:text-left">
            <div className="flex flex-wrap items-center justify-center xl:justify-start gap-4">
              <span className="text-[10px] font-black text-sky-400 uppercase tracking-[0.3em] bg-sky-400/10 px-5 py-2.5 rounded-xl border border-sky-400/20">
              ...
              <div className="flex items-center gap-2 text-[10px] font-black text-slate-500 uppercase tracking-widest font-mono">
                ...
                <Zap size={14} className="text-orange-500" /> HIGH INTENSITY
              </div>
            </div>

            <h3 className="text-5xl md:text-6xl font-black text-white tracking-tighter leading-[0.85] italic uppercase">
              Elite Full-Body <br />
              Oxidation Blast
            </h3>

            <p className="text-slate-400 font-medium leading-relaxed text-lg max-w-2xl">
              Glucose levels and circadian data indicate your EPOC capacity is
              at its 24-hour peak. Executing this now will optimize
              thermogenesis through the sleep cycle.
            </p>
            ...
            <div className="pt-6 flex flex-wrap items-center justify-center xl:justify-start gap-12">
              <button className="flex items-center gap-4 bg-white text-slate-950 px-12 py-6 rounded-[2rem] font-black text-xs uppercase tracking-[0.25em] shadow-2xl transition-all hover:bg-sky-400 hover:text-slate-950 active:scale-95">
                <Link to={"/dashboard/workouts"}>Workout's</Link>{" "}
    ...
    >
      ...
      <div className="relative z-10">
        <div className="mb-12 flex items-center justify-between">
          <div
            className={`flex h-20 w-20 items-center justify-center rounded-[1.75rem] shadow-2xl transition-all duration-500 group-hover:scale-110 group-hover:rotate-6 ${colorClass}`}
          >
            {icon}
          </div>
        ...
        <p className="text-[11px] font-black uppercase tracking-[0.35em] text-slate-500 mb-4 italic leading-none">
          {title}
        </p>
        <div className="flex items-baseline gap-3">
          <h4 className="text-6xl font-black text-white tracking-tighter tabular-nums italic">
            {value}
          </h4>
