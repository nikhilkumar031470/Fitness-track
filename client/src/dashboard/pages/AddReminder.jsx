  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:3000/api/add-reminder",
        reminderData,
      );
      ...
      <div className="w-full max-w-5xl bg-[#0b0f14] rounded-2xl border border-gray-800/50 shadow-2xl p-12">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-12">
            <div className="space-y-3">
              <label className="flex items-center gap-2 text-[11px] font-black uppercase tracking-[0.2em] text-gray-400 ml-1">
                <ChevronRight className="w-3.5 h-3.5 text-[#00a3ff]" /> Protocol
                Title
              </label>
            ...
            <div className="space-y-3">
              <label className="flex items-center gap-2 text-[11px] font-black uppercase tracking-[0.2em] text-gray-400 ml-1">
                <ChevronRight className="w-3.5 h-3.5 text-[#00a3ff]" /> Alert
                Level
              </label>
              <div className="relative">
                <select
          ...
          <div className="mb-12 space-y-3">
            <label className="flex items-center gap-2 text-[11px] font-black uppercase tracking-[0.2em] text-gray-400 ml-1">
              <StickyNote className="w-3.5 h-3.5 text-amber-400" /> Strategy
              Notes
            </label>
            <textarea
