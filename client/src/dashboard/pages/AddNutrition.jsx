  ...
  const handleSubmit = async (e) => {
    try {
      ...
      const response = await axios.post(
        "http://localhost:3000/api/add-nutrition",
        {
          mealType,
          date: entryDate,
          foodName,
      ...
      <div className="w-full max-w-6xl bg-[#0B121E] rounded-[24px] border border-[#1A2637] p-6 sm:p-10 lg:p-14 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-10 border-b border-[#1A2637] pb-8">
          <div className="flex items-center gap-5">
            ...
            <div>
              <h2 className="text-white text-2xl font-black tracking-tight italic uppercase leading-none">
                Nutrition Tracker
              </h2>
              <p className="text-[#4F6B8A] text-[10px] tracking-[0.2em] font-bold mt-2 uppercase">
                Log New Intake Protocol
              </p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-2">
              <label className="text-[#8B9DB1] text-[11px] font-bold tracking-widest uppercase ml-1">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 pt-4">
            <div className="bg-[#0D1624] border border-[#1E293B] p-5 sm:p-8 rounded-2xl flex flex-col items-center hover:bg-[#151D29] transition-all group">
              <Flame
                className="text-gray-500 mb-3 group-hover:text-white"
                size={20}
              />
              <label className="text-white text-[10px] font-black tracking-widest mb-2 uppercase opacity-60">
                Calories
              </label>
              <input
                type="number"
            ...
            <div className="bg-[#0D1624] border border-[#1E293B] p-5 sm:p-8 rounded-2xl flex flex-col items-center hover:border-[#00E5FF]/40 transition-all group">
              <Dna
                className="text-[#00E5FF] mb-3 opacity-50 group-hover:opacity-100"
                size={20}
              />
              <label className="text-[#00E5FF] text-[10px] font-black tracking-widest mb-2 uppercase">
                Proteins
              </label>
              <input
                type="number"
            ...
            <div className="bg-[#0D1624] border border-[#1E293B] p-5 sm:p-8 rounded-2xl flex flex-col items-center hover:border-[#AA00FF]/40 transition-all group">
              <Wheat
                className="text-[#AA00FF] mb-3 opacity-50 group-hover:opacity-100"
                size={20}
              />
              <label className="text-[#AA00FF] text-[10px] font-black tracking-widest mb-2 uppercase">
                Carbs
              </label>
              <input
                type="number"
            ...
            <div className="bg-[#0D1624] border border-[#1E293B] p-5 sm:p-8 rounded-2xl flex flex-col items-center hover:border-[#FFAA00]/40 transition-all group">
              <Droplet
                className="text-[#FFAA00] mb-3 opacity-50 group-hover:opacity-100"
                size={20}
              />
              <label className="text-[#FFAA00] text-[10px] font-black tracking-widest mb-2 uppercase">
                Fats
              </label>
              <input
                type="number"
