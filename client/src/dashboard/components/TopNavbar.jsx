...
const UserMenu = ({ onLogout, loggedUser }) => (
  ...
  src={
    loggedUser?.profilePic 
      ? `http://localhost:3000/uploads/${loggedUser.profilePic}`
      : `https://ui-avatars.com/api/?name=${loggedUser?.fullName}&background=0ea5e9&color=fff`
  }
  ...
  onError={(e) => {
    e.target.src = `https://ui-avatars.com/api/?name=${loggedUser?.fullName}&background=0ea5e9&color=fff`;
  }}
/>
