...
export default function Analytics() {
  ...
  const fetchProgress = async () => {
    ...
    try {
      ...
      // Filter progress for logged user only
  ...
  const fetchNutrition = async () => {
    ...
    try {
      ...
      // Filter meals belonging to logged user
        ...
        <aside className="bg-[#0f172a] border border-slate-800 p-8 rounded-[2.5rem] flex flex-col justify-between shadow-2xl">
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <SummaryItem label="Active Streak" value={activeDays} unit="days" color="text-orange-400"/>
  ...
  return (
    ...
    <div>
      ...
      <div className="flex items-baseline gap-1">
        ...
        <span className={`text-2xl font-black italic ${color}`}>
          {value}
        </span>
