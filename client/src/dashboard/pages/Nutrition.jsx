...
export default function Nutrition() {
  ...
  const fetchNutrition = async () => {
    try {
      ...
      const allNutrition = response.data.nutritiondata || [];

      const userMeals = allNutrition.filter(
  ...
  const getColor = (type) => {
    ...
    if (type === "Lunch")
      return { color: "text-indigo-400", bg: "bg-indigo-400/10" };
    if (type === "Snack")
        ...
        <div className="xl:col-span-1 space-y-8">
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="bg-slate-800/30 p-4 rounded-2xl border border-slate-700/50">
                  ...
                  <p className="text-xl font-black text-rose-500 italic">420</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 bg-sky-500 rounded-[3rem] text-slate-950 shadow-2xl">
            ...
            <h3 className="text-5xl font-black mb-1 italic">
              ...
              <span className="text-xl opacity-40">LTR</span>
            </h3>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-6">
                        <div
                          className={`w-16 h-16 flex items-center justify-center rounded-2xl ${style.bg} ${style.color}`}
                        >
                        ...
                        <div>
                          <span
                            className={`text-[10px] font-black uppercase ${style.color}`}
                          >
                            {meal.mealType}
                          </span>
