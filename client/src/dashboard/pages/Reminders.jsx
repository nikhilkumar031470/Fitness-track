...
// 🔹 Function to calculate progress based on reminder time
const calculateProgress = (date, time) => {
  ...
  const total = 24 * 60 * 60 * 1000; // 24 hours window
    ...
    >
      ...
      <div className="flex items-center gap-4 mb-2 relative z-10 text-[10px] font-black uppercase tracking-tighter">
        ...
        <div className="flex items-center gap-1 text-gray-500 bg-gray-50 dark:bg-white/5 px-2 py-0.5 rounded-md">
          <Clock size={12} className={theme.text} /> {reminder.date?.split("T")[0]}
        </div>
      ...
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-8 mb-12">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          >
            ...
            <Link to={"/dashboard/add-reminders"}>
              NEW REMINDER
            </Link>
