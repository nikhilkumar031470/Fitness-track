...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      console.log("Legacy Initialized:", response.data);
        ...
        >
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            <div className="space-y-4">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-slate-900/40 border border-slate-800/80 text-white p-5 pl-14 rounded-2xl focus:border-sky-500/50 focus:ring-4 focus:ring-sky-500/5 focus:outline-none transition-all font-bold text-sm placeholder:text-slate-700"
                  required
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-900/40 border border-slate-800/80 text-white p-5 pl-14 rounded-2xl focus:border-sky-500/50 focus:outline-none transition-all font-bold text-sm placeholder:text-slate-700"
                    required
                  />
                  <button 
                    type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-sky-500 text-slate-950 font-black p-5 rounded-2xl hover:bg-sky-400 transition-all uppercase tracking-[0.25em] flex items-center justify-center gap-3 mt-8 shadow-2xl shadow-sky-500/20 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed group"
            >
              {loading ? (
          ...
          <p className="text-slate-500 text-center mt-12 text-[11px] font-black uppercase tracking-[0.2em]">
            ...
            <Link
              to="/login"
              className="text-white hover:text-sky-400 transition-all ml-2 underline underline-offset-8 decoration-sky-500/50"
            >
              Access Vault
            </Link>
          </p>
